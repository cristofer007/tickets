...
<script>
        ...
        function irAForo()
        {
            window.location.href = "foroJefeGrupo.php";
        }
        
        function irAChat()
        {
            window.location.href = "recursosJefeGrupo.php";
        }
        ...
        function mostrarBotones()
	{
        ...
        //---------------------------------------------------------------------------------------------------------------
        function cambiarPanelEscribir()
        {
            
        }
        
        function cambiarPanelGrupos()
        {
            
        }
        
        function cambiarPanelBusqueda()
        {
