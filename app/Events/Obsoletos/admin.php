	...
	<body>
		<div class="container">
			...
			<div class="container bg-light mb-4 p-2">
				<div class="row mb-4">
					<?php
					$secciones = array("Entrantes", "Nuevos", "Asignados", "Resueltos", "Aceptación pendiente");
					$vals = array(9, 0, 1, 2, 3);
					for($i = 0; $i < 5; $i++)
					{
				...
				<?php echo '<a class="fw-light m-3" href="/admin.php?tipo='.$tipoTicket.'">[Limpiar busqueda]</a>'?>
