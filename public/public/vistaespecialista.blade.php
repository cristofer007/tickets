...
*******************************************************************************************************************************-->
	...
	<body class="p-0">
		...
		<div class="container mx-auto border border-danger px-0 py-0" style="position:absolute; width:100%; top:7%">
			
<!--			<div class="row justify-content-end">
                            <div class="col-auto">
					<a class="btn btn-primary" href="/vistalogin">Salir</a>
				</div>
			</div>-->
			<div class="container bg-light border border-danger">
				<div class="row border border-danger">
					...
					$secciones = array("Asignados", "Resueltos", "Nuevos");
					$vals = array(1, 2, 0);
					for($i = 0; $i < 3; $i++)
					{
						echo '<div class="col-4 text-center my-1" >';
						if($vals[$i] == $tipoTicket)
							echo $secciones[$i];
						else
							echo '<a href="/vistaespecialista.blade.php?tipo='.$vals[$i].'&t='.$token.'">'. $secciones[$i] .'</a>';
						echo '</div>';
					}
					?>
					<!-- <div class="col-2">
				...
				<div class="input-group border border-danger w-75 mx-auto">
					<div class="form-outline mx-auto w-75">
						<input type="search" id="directSearch" class="form-control" onChange="search1()"/>
					</div>
					<button type="button" class="btn btn-primary mx-auto w-25" onClick="search1()">
                                            Buscar
                                        </button>
				</div>
