...
<html lang="en">
	...
	<body>
		<div class="container">
			<h2 style="" class="text-center py-3 px-0">Sistema de ayuda</h2>
			...
			<div class="container bg-light mb-4 p-0">
				<div class="row mb-4 w-100 mx-auto">
					<?php
					$secciones = array("Libres", "Asignados", "Resueltos", "Cerrados");
					$vals = array(0, 1, 3, 2);
					for($i = 0; $i < 4; $i++)
					{
						echo '<div class="col-3 text-center align-middle p-0 m-0 border" >';
				...
				<div class="input-group text-center justify-content-center">
					...
					<button type="button" class="btn btn-primary text-center" onClick="search1()">
                                                Buscar
                                        </button>
				</div>
				<?php 
                                ...
                                .
                                '<a class="fw-light m-3 " href="/tecnico.php?tipo='.$tipoTicket.'&t='. $token .' ">[Limpiar busqueda]</a>'
                                .     '</div>'   
						...
						<table class="table table-striped mt-4">
							...
							<tbody id="resultsTable">
                                                            ...
                                                            foreach($stmt as $row)
                                                            {
                                                                ...
                                                                echo '<td style="line-height:1.1em">'. $row['titulo'] .'</td>';
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header" style="background-image: linear-gradient(50deg, #457fca, #5691c8); color:white;">
						<h5 class="modal-title" style="margin-left:31%" id="exampleModalLabel">Detalles del ticket</h5>
					...
					<div class="modal-body">
						...
						<textarea id="oProblema" style="line-height: 1em" class="boxsizingBorder" readonly></textarea>
						<div id="modalOpt"></div>
					</div>
...
<!--		<div class="modal fade" id="asignarModal" tabindex="-1" aria-labelledby="asignarModalLabel" aria-hidden="true">
		...
		<script>
			...
			{
				var obj = {
					resolucion: document.getElementById("iResp").innerHTML,
					codigo: editCode
				};
			...
			function search1()
			{
				...
				let request = "/tecnico.php?tipo="+tipoTicket+"&t="+token ;
